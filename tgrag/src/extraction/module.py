"""
DSPy modules for entity and relationship extraction (UNUSED by default).
...
not the DSPy-based approach implemented here.

This module provides:
- `TypedEntityRelationshipExtractor`: DSPy module for extracting entities and relationships
- Entity and Relationship Pydantic models
- DSPy signatures for extraction, critique, and refinement
"""

import dspy
from pydantic import BaseModel, Field
from ..utils.helpers import clean_str, logger
